function varargout=shadedErrorBara(x,y,errBar,lineProps,transparent)
...
H.edge(1)=plot(x,lE,'-','color',edgeColor,'LineWidth',0.1);
H.edge(2)=plot(x,uE,'-','color',edgeColor,'LineWidth',0.1);
